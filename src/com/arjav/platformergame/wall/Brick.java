...
public class Brick extends Tile{
	...
	// class constructor
	public Brick(int x, int y, int width, int height, Id id, Game game, int level) {
		super(x, y, width, height, id, game, level);
	}
	
	// method to draw or render
	public void render(Graphics g) { // to make sure the sprite does not get rendered if it is not on the screen
	...
	public void init() {
		me = game.brick.getBufferedImage();
	}
